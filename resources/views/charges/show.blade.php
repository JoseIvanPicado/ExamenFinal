        ...
        <div class="card bg-secondary shadow">
            ...
            <div class="card-header b-white border-0">
                <div class="row align-items-center">
                    <div class="col-8">
                        <h3 class="mb-0"><i class="fas fa_newspaper"></i> Detalles de los cargos</h3>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <i class="fas fa-briefcase"></i> Tipo de Cargo
                                </label>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <i class="fas fa-briefcase"></i> Requerimientos para el cargo
                                </label>
